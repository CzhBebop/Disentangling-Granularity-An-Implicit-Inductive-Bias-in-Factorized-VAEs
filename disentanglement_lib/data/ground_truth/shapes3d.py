...
SHAPES3D_PATH = "E:/python3.8.10/disentanglement_lib-master/bin/3dshapes/3dshapes.npz"
...
class Shapes3D(ground_truth_data.GroundTruthData):
  ...
  def __init__(self):
    ...
    self.images = (
        images.reshape([480000, 64, 64, 3]).astype(np.float32) / 255.)
    features = labels.reshape([480000, 6])
