...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.latent = QuantizedLatent(num_latents=12, num_values_per_latent = 12, optimize_values=True)
...
if __name__ == "__main__":
    ...
    for j in range(10):
        ...
        torch.save(model.state_dict(),folder_path + '/model'+str(j)+'.pt')
